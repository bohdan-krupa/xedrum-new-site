    ...
    return (
        <div className="flex flex-col gap-8">
            {caseData.map((c, i) => (
                <div
                    key={i}
                    className={`flex flex-col-reverse md:flex-row gap-6 lg:gap-16 rounded-2xl p-6 ${i % 2 === 1 ? "md:flex-row-reverse" : ""
                        }`}
                >
                    ...
                    <div className="flex-1 flex flex-col gap-4">
                        ...
                        <Link href={`/case-studies/${c.id}`} className="mt-2 inline-block">
                            <WhiteArrowButton
                                title="More Details"
