        ...
        <div className="w-full lg:mx-auto py-9 lg:py-24">
            <div className='flex flex-col-reverse md:flex-row gap-12 md:gap-16 lg:gap-0
                ...
                <div className='flex flex-row min-w-max justify-center relative'>
                    ...
                    <div className="absolute bottom-0 md:bottom-0 lg:bottom-24 bg-white inset-shadow-sm w-2xs lg:left-6/8 p-1 flex flex-row rounded-2xl">
                        <span className='px-2 py-3'><FolderIcon /></span>
                        <div className='flex flex-col p-2'>
                            <span className='font-bold font-inter'>60+ projects</span>
                            <span className='text-[14px]'>successfully delivered for clients across Europe and the US.</span>
                        </div>
                    </div>
                </div>
                <div className="flex flex-col justify-between">
                    <div className='flex flex-col gap-1.5 pt-6 px-8'>
                        ...
                        <h2 className='text-[28px] lg:text-[54px] font-bold'>Who We Are</h2>
                        <p className="text-[14px] lg:text-[16px]">At Xedrum, we don’t just build software — we build long-term partnerships. With years of experience, dozens of successful projects, and a team of
                            skilled engineers, we help startups and enterprises grow with confidence. We believe in transparency, quality,
                            and bold ideas — that's why over 98% of our clients stay with us.</p>
                    </div>
            ...
            <div className="flex flex-row gap-4 justify-center text-center text-[12px]">
