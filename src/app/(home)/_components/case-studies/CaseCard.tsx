        ...
        <div className="flex flex-col gap-2 overflow-hidden">
            <div className="w-full h-[280px] sm:h-[340px] lg:h-[380px] bg-green-primary rounded-2xl flex flex-col justify-between">
                <div className="flex justify-end relative">
                    <span className="bg-white text-p-sm px-12 sm:px-16 py-1.5 absolute top-6 sm:top-8 -left-10 sm:-left-12 -rotate-45">
                        * case study *
                    </span>
                ...
                <div className="flex flex-wrap gap-2 m-3 sm:m-4">
                    {tags.map((tag) => (
                        <p key={tag} className="bg-white px-2 py-1 rounded-lg text-center text-p-sm">
                            {tag}
                        </p>
                    ))}
                </div>
